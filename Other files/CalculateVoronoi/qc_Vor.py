...
print 'calculating vertex distribution...'
...
fout='./vert_g_{:0.4f}_s_{:d}_k_{:d}'.format(g,seed,kmax)
np.savez(fout,cts=cts,vt=v_types,va=v_areas,g=g,s=seed,k=kmax)
...
fout='./vor2_g_{:0.4f}_s_{:d}_k_{:d}'.format(g,seed,kmax)
